...
const SidebarLogo = (props: PropsType) => {
  ...
  return (
    <div className='app-sidebar-logo px-6 bg-colorw' id='kt_app_sidebar_logo'>
      <Link to='/dashboard'>
        {config.layoutType === 'dark-sidebar' ? (
          ...
          <>
            ...
            <img
              alt='Logo'
              src={logo}
              className='h-10px app-sidebar-logo-default theme-dark-show'
            />
          </>
        )}
        ...
        <img
          alt='Logo'
          src={logo}
          className='h-10px app-sidebar-logo-minimize'
        />
      </Link>
